"""Run refine13 with full passband integrity report."""
import json
import math
import subprocess
...
OUT_ROOT = ROOT / "12GHzdiplexer2" / "derived" / "refine13"
...
def report(name, fr, s11, s21, s31):
    ...
    print(f"  S21 edge  : {hpf_s} GHz   HPF worst IL 20-35GHz: {hpf_il:.1f} dB")
    ...
    print(f"  S31: @15={at(fr,s31,15):.1f} @16={at(fr,s31,16):.1f} @17={at(fr,s31,17):.1f}"
          f" @18={at(fr,s31,18):.1f} @19={at(fr,s31,19):.1f}")
    print(f"  S11: @19={at(fr,s11,19):.1f} @20={at(fr,s11,20):.1f}"
          f" @21={at(fr,s11,21):.1f} @22={at(fr,s11,22):.1f}")
