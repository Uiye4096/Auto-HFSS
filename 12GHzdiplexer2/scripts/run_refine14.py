"""Run refine14: LPF element scaling test."""
import json
import math
import subprocess
...
OUT_ROOT = ROOT / "12GHzdiplexer2" / "derived" / "refine14"
...
def report(name, fr, s11, s21, s31):
    ...
    hil  = min(at(fr, s21, f) for f in [20, 21, 22, 23, 25, 28, 30, 35])
    ...
    print(f"  HPF edge : {hpf_s} GHz   HPF worst IL: {hil:.1f} dB")
