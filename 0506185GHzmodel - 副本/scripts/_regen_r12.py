"""Regenerate plot_30g.html for Round 12 cases with updated metrics."""
...
CASES = [
    ("087", "087_L7g3_083_g4052"),
    ("072", "072_L7g4_052"),
]
for uid, dname in CASES:
    ...
    print(f"[{uid}]  S31@19={m['S31_at_19GHz_dB']:.1f}  S31@20={m['S31_at_20GHz_dB']:.1f}  S31_stop={stop:.1f}  S11w={s11w:.1f}  rpl={m['ripple_20_25GHz_dB']:.2f}")
    title = f"[{uid}] {dname}  S31⌊18.5-28.5⌋={stop:.1f}  S11w={s11w:.1f}dB"
